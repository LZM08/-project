...
#     recognizer.write('Data Learning/Data Learning.yml')
...
if __name__ == '__main__':
    input_path = 'E:\얼굴인식 출석체크\data\img'  # 입력 이미지 폴더 경로
    output_path = 'E:\얼굴인식 출석체크\data\imgpgm'  # PGM 형식으로 변환한 이미지 저장 폴더 경로
    ...
    recognizer = cv2.face.LBPHFaceRecognizer_create()
    recognizer.train(faces, ids)
    recognizer.write('Data Learning/datalearning.yml')  # 학습된 모델 저장